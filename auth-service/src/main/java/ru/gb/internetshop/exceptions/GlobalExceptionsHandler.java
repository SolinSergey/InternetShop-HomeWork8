...
public class GlobalExceptionsHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<AppError> handleUsernameIsAlreadyPresent(UsernameIsAlreadyPresent e){
        return new ResponseEntity<>(new AppError("USERNAME_IS_ALREADY_PRESENT",e.getMessage()), HttpStatus.NOT_FOUND);
    }
}
